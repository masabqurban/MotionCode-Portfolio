      ...
      <div className='body dark:bg-[#111] bg-[#ececec] text-white'>
        ...
        <section id='project' className='max-w-screen-xl mx-auto px-4 relative pb-8 sm:pb-16'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 mt-8 sm:gap-[80px] items-center sm:mt-20 relative'>
            <div className='h-[1px] left-1/4 right-1/2 bg-[#9c3507] dark:bg-[#d9784e] absolute top-1/2 hidden sm:block'>
            </div>
            <div className='w-4 h-4 rounded-full border-[3px] border-[#9c3507] dark:border-[#d9784e] absolute left-1/2 -translate-x-1/2 bg-[#ececec] dark:bg-[#111] z-10 hover:scale-110 ease-in-out duration-100 hidden sm:block'>
            </div>
            <a href="https://tool-matrix.vercel.app/" className='flex w-full relative justify-center sm:justify-start'>
              <div className='flex flex-col items-center relative group sm:hover:scale-105 ease-in-out duration-200'>
                ...
                <span className='font-lexend flex group-hover:-top-14 ease-jump duration-200 bg-[#9c3507] dark:bg-[#d9784e] text-white dark:text-black sm:absolute left-1/2 sm:-translate-x-1/2 top-5 px-2 py-1 text-sm sm:text-base mt-2 rounded-md w-max items-center gap-1 after:hidden sm:after:block after:w-4 after:h-4 after:bg-inherit after:absolute after:left-1/2 after:-translate-x-1/2 after:rotate-45 after:-bottom-2 transition-all'> Tool Matrix
                  <img src={blacklink} alt="" className='feather feather-external-link hidden dark:block' />
                  <img src={link} alt="" className='feather feather-external-link dark:hidden' />
                </span>
              </div>
            </a>
