  ...
  return (
    <StyledWrapper>
      <div className="social-login-icons">
        <a href='https://x.com/Masab_Qurban' target='_blank' className="socialcontainer">
        ...
        <a href='https://www.instagram.com/masabqurban/' target='_blank'  className="socialcontainer">
        ...
        <a href='https://web.facebook.com/masabqurban' target='_blank'  className="socialcontainer">
        ...
        <a href='https://github.com/masabqurban' target='_blank'  className="socialcontainer">
